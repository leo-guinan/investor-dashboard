...
interface GetMoreInfoModalProps {
  isDark: boolean;
  onClose: () => void;
  dealData: FileData;
}

const GetMoreInfoModal: React.FC<GetMoreInfoModalProps> = ({ isDark, onClose, dealData }) => {
  const [copied, setCopied] = useState(false);
  const [emailContent, setEmailContent] = useState({
    subject: `Re: ${dealData.company} - Additional Information Request`,
    body: `Hi ${dealData.founders[0]?.name},

Thank you for sharing your pitch deck. Could you please provide additional details about your unit economics, customer acquisition strategy, and detailed financial projections? This will help us better evaluate the opportunity.
